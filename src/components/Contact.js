      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <form onSubmit={handleSubmit} className="p-8 rounded-2xl shadow-lg bg-white">
              ...
              <div className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-purple-600 text-white rounded-xl flex items-center justify-center"
                >
